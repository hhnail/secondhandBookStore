...
<body>
	<div id="main">
	<form id="m_d" action="BookListServlet?method=mDeleteBookListByISBN" method="post">
		<table>
			<tr>
			    <td></td>
				<td>ISBN</td>
			...
			<c:forEach items="${requestScope.bookListsInPage.list }" var="bookListsInPage">
				<tr>
				    <td><input type="checkbox" value="${bookListsInPage.ISBN }" name="m_delete"></td>
			...
			<tr>
				...
				<td></td>
				<td></td>
				<td><a id="m_d" onclick="sub()">批量删除</a></td>
